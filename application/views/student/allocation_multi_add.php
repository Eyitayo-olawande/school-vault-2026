        ...
        <section class="panel">
            ...
            <header class="panel-heading">
                <h4 class="panel-title">
                    <i class="fas fa-file-archive"></i> <?=translate('allocation_multiple_import')?>
                </h4>
            </header>
            <div class="panel-body">
                ...
                <div class="form-group mt-md">
                    <div class="col-md-12 mb-md">
                        <a class="btn btn-default pull-right"
                            href="<?=base_url('student/csv_SampleAllocationdownloader')?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 mb-lg">
                        <input type="file" name="allocationfile" class="dropify" data-height="140"
                            data-allowed-file-extensions="csv" />
                        <?php echo form_error('allocationfile', '<label class="error">', '</label>'); ?>
                    </div>
                </div>
            </div>
