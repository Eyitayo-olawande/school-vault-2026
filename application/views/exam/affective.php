    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <header class="panel-heading">
                <h4 class="panel-title">Affective Domain — Select Class</h4>
            </header>
        ...
        <section class="panel appear-animation" data-appear-animation="<?=$global_config['animations']?>" data-appear-animation-delay="100">
            <?php echo form_open('exam/affective_save', ['class' => 'frm-submit-msg']); ?>
            <?php
            echo form_hidden(['exam_id' => $exam_id, 'class_id' => $class_id, 'section_id' => $section_id, 'branch_id' => $branch_id]);
            ?>
            <header class="panel-heading">
                <h4 class="panel-title"><i class="fas fa-users"></i> Affective Domain Ratings</h4>
            </header>
            <div class="panel-body">
        ...
        <div class="alert alert-info"><i class="fas fa-info-circle"></i> No students found or no affective domain types configured for this branch.</div>
        <?php endif; ?>
    </div>
</div>
<script>
