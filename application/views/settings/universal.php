		...
		<div class="tab-content">
			<div class="tab-pane box <?=(empty($this->session->flashdata('active')) ? 'active' : '');?>" id="setting">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <?php
                        // Labels are the real output of currencyFormat() for 12300000.50, so what
                        // you pick is what you get. Values 3 and 5 previously showed an identical
                        // label despite 3 rendering three decimal places.
                        $digitArray = array(
                            '' => translate('select'),
