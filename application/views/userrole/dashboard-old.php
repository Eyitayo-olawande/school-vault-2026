<?php if (empty($student_id)): ?>
   ...
   <div class="col-md-12 col-lg-3 col-xl-4">
     <a href="<?=base_url('userrole/invoice');?>" class="chil-shaw btn btn-secondary btn-circle pull-right" style="margin-right: 10px;">
        <i class="fas fa-tachometer-alt"></i> <?=translate('fees_history')?>
    </a>
    </div>
</div>
