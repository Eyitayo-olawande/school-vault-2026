                        ...
                        <?php if(get_permission('student', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'student/view' || $sub_page == 'student/profile') echo 'nav-active';?>">
                                <a href="<?=base_url('student/view')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('view_students - Class')?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'student/search' || $sub_page == 'student/profile') echo 'nav-active';?>">
                                <a href="<?=base_url('student/search')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('view_students - All')?></span>
                                </a>
                            </li>
