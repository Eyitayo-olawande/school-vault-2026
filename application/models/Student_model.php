...
class Student_model extends MY_Model
{
    ...
    public function csvImport($row = array(), $classID = '', $sectionID = '', $branchID = '')
    {
        ...
        /* Hafeez Lawal Addition 2025-01-20
        Req 1 and 7: ⁠⁠Student pictures to default to Firstname.Lastname.jpg per student
        */
        $studentPhoto = $row['FirstName'].'.'.$row['LastName'].'.jpg';
        $inser_data1 = array(
